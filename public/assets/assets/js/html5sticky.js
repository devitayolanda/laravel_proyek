...
html5sticky.addUtilityButtons = function(el){
   ...
   $('.icons-footer').append('<img class="left shrink ficon" src="assets/assets/img/shrink.png" alt="" title="shrink/expand">');
   $('.icons-footer').append('<img class="left alarm ficon" src="assets/assets/img/alarm.png" alt="" title="set alarm for this sticky note">');
   $('.icons-footer').append('<img class="left lock ficon" src="assets/assets/img/lock.png" alt="" title="lock this sticky note">');
   $('.icons-footer').append('<img class="left settings ficon" src="assets/assets/img/settings.png" alt="" title="settings for note">');
   $('.icons-footer').append('<img class="left email ficon" src="assets/assets/img/email.png" alt="" title="email this sticky note">');
   $('.icons-footer').append('<img class="left tweet ficon" src="assets/assets/img/tweet.png" alt="" title="tweet this sticky note">');
   $('.icons-footer').append('<img class="left share ficon" src="assets/assets/img/share.png" alt="" title="share this sticky note">');
...
html5sticky.editNote = function($clone, el){
   ...
   // put in Close button
   $('<a href="#" class="close_stickynote"><img src="assets/assets/img/deletebig.png" alt="" title="close note"></a>')
      .css({
         position:'absolute',
         top:7,
         right:5
   ...
   // put in Save button
   $('<a href="#" class="save_stickynote"><img src="assets/assets/img/savebig.png" alt="" title="save note"></a>')
      .css({
         position:'absolute',
         top:7,
         right:60
...
html5sticky.addPin = function(el){
    var close = $('<div><a href="#" class="delete_stickynote"><img src="assets/assets/img/delete.png" alt="" title="delete note"></a></div>');
    var tag = $('<div align="center"><img src="assets/assets/img/pin.png" alt=""></div>');
